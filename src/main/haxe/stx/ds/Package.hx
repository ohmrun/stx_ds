...
typedef XSet<S,T>     = stx.ds.xset.pack.XSet<S,T>;

typedef XerSet<K,V>   = stx.ds.pack.XerSet<K,V>;
typedef List<T>       = stx.ds.pack.List<T>;
typedef Lst<T>        = stx.ds.head.data.List<T>;

typedef BTree<T>      = stx.ds.pack.BTree<T>;
typedef LBTree<T>     = stx.ds.pack.LBTree<T>;

typedef Nel<T>        = stx.ds.pack.Nel<T>;
typedef RoseTree<T>   = stx.ds.pack.RoseTree<T>;
typedef KTree<T>      = stx.ds.pack.KTree<T>;
typedef LStream<T>    = stx.ds.pack.LStream<T>;  
